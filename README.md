...
| `Full_Subtractor.v` | Full subtractor circuit |
| `UniversalShift.v` | Universal shift register |
| `PriorityEncoder.v` | Priority encoder |

Each design includes a corresponding testbench for functional verification.
...
| Module | Description |
|---|---|
| `SPI_protocol.v` | Full SPI master-slave implementation |
| `SPI_protocol_tb.v` | Functional verification testbench |
...
| Tool | Purpose |
|---|---|
| Xilinx Vivado | RTL design, simulation and synthesis |
